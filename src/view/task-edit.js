...
export default class TaskEdit extends SmartView {
  ...
  _getTemplate() {
    return this._createTaskEditTemplate(this._data);
  }
  ...
  _createTaskEditTemplate(data) {
    ...
    const dateTemplate = this._createTaskEditDateTemplate(dueDate, isDueDate, isDisabled);

    const repeatingClassName = isRepeating
      ? `card--repeat`
      : ``;
    const repeatingTemplate = this._createTaskEditRepeatingTemplate(repeating, isRepeating, isDisabled);
